    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center mb-6">
                ...
                <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-200">Edit Skill: {{ $skill->name }}</h2>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700">
                <form action="{{ route('admin.skills.update', $skill) }}" method="POST" class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex justify-between text-sm">
                                    ...
                                    <span class="text-indigo-600 dark:text-indigo-400 font-medium" id="levelValue">{{ old('level', $skill->level) }}%</span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                Current icon: <span class="text-indigo-600 dark:text-indigo-400">{!! $skill->icon_html !!}</span>
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex gap-3">
                                <input type="color" name="color" id="color" value="{{ old('color', $skill->color ?? '#6366f1') }}"
                                       class="h-10 w-20 rounded border border-gray-300 dark:border-gray-600 cursor-pointer">
                                <input type="text" name="color_hex" id="color_hex" value="{{ old('color', $skill->color ?? '#6366f1') }}"
                    ...
                    <div>
                        ...
                        <input type="number" name="display_order" id="display_order" value="{{ old('display_order', $skill->display_order) }}" min="0"
                               class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200 dark:focus:ring-indigo-800 transition-colors duration-200">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                                  class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200 dark:focus:ring-indigo-800 transition-colors duration-200"
                                  placeholder="Brief description of your skill...">{{ old('description', $skill->description) }}</textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="is_featured" class="sr-only peer" value="1" {{ old('is_featured', $skill->is_featured) ? 'checked' : '' }}>
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="is_active" class="sr-only peer" value="1" {{ old('is_active', $skill->is_active) ? 'checked' : '' }}>
                                <div class="w-11 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-indigo-300 dark:peer-focus:ring-indigo-800 rounded-full peer dark:bg-gray-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-indigo-600"></div>
                            </label>
                        </div>
                    </div>
